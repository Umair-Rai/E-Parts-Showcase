...
const OTPVerification = ({ email, onBack, onOTPVerified, userType = "customer" }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(buildApiUrl('/api/auth/verify-otp'), {
        email: email,
        otp: otp,
        userType,
      });
