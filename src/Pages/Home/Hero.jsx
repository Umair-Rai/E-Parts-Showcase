...
export default function Hero() {
  ...
  return (
    <div className="relative h-[70vh] md:h-[90vh] w-full overflow-hidden bg-black">
      ...
      <button
        className="swiper-button-prev-custom hidden sm:flex z-30 absolute top-1/2 left-4 -translate-y-1/2 bg-black/60 hover:bg-red-600/80 border border-red-600/30 hover:border-red-600 p-3 rounded-full transition-all duration-300 group"
      ...
      <button
        className="swiper-button-next-custom hidden sm:flex z-30 absolute top-1/2 right-4 -translate-y-1/2 bg-black/60 hover:bg-red-600/80 border border-red-600/30 hover:border-red-600 p-3 rounded-full transition-all duration-300 group"
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          Critical Quality Standards for Trustworthy Genset Motors and various Mechanisms
          </h1>
          <p className="text-lg md:text-xl text-gray-300 mt-4 max-w-3xl mx-auto drop-shadow-sm leading-relaxed">
          Supplier of high-quality mechanical and electrical components for water pumps, motors, compressors, and gensets serving commercial and industrial applications
          </p>
