...
export default function ProductCategories() {
  ...
  // Images from DB: "/uploads/categories/seal1.jpg" → `${API_BASE_URL}/uploads/categories/seal1.jpg`
  const getCategoryImages = (category) => {
    if (!category.pic) return [];
    
    // Use the centralized image processing utility
    const images = processImageArray(category.pic, {
      defaultFolder: '/uploads/categories'
    });
    
    // Log for debugging
    console.log('📸 Category:', category.name, 'Original pic:', category.pic, 'Processed URLs:', images);
